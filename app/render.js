import { archiveHandler } from './handlers.js'

export const renderNotesList = (store) => {
    ...
    store.listData.forEach((listItem)=> {
        ...
        let iconPath = null;
        for (let key in store.noteIconPath) { 
            if(key == listItem.type) {
                iconPath = store.noteIconPath[key]
            }
        };
        ...
        noteItem.innerHTML = `<div class="note__name">
                                ...
                                <input class="note__text" type="text" value="${listItem.name}">
                                      
                              </div>
                              <input class="note__text" type="text" value="${listItem.createData}">
                              <input class="note__text" type="text" value="${listItem.category}">
                              <input class="note__text" type="text" value="${listItem.content}">
                              <input class="note__text" type="text" value="${listItem.schedule}">
                              <div class="note__controls controls">

                                <svg class="controls__editBtn"
                                     id="editBtn"version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
